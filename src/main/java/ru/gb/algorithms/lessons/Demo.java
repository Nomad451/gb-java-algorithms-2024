package ru.gb.algorithms.lessons;
...
//        List<Integer> availableDivider = findAvailableDivider(100);
...
//        }
    ...
    // Квадратичная сложность(зависимость) - O(n^2)
    ...
    // Экспоненциальная сложность(рост) - O(2^n)
